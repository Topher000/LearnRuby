...
# Methods calling Procs # of times
...
puts do_until_false([20], build_array_of_squares).inspect
yum = "Lemonade is great"
puts do_until_false(yum, always_false)

# methods that rturn Procs
